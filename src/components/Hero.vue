  ...
  <section class="hero">
    <div class="container">
      <div class="hero-content">
        <h1>Automate Your Jewelry Pricing Based On Live Spot Metal Price Rates</h1>
        <p>BullionSync automatically updates your Shopify store's jewelry prices based on real-time precious metal market values, saving you time and maximizing profits.</p>
        <div class="hero-buttons">
          <button 
            class="btn-primary btn-large" 
            data-tally-open="w8WZYx" 
            data-tally-layout="modal" 
            data-tally-emoji-animation="wave"
            @click="trackInstallClick"
          >
